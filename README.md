...
| pressDelay                        | Number &#124; Function                                    | `0`                                                                                                            | If you'd like elements to only become sortable after being pressed for a certain time, change this property. A good sensible default value for mobile is `200`. Cannot be used in conjunction with the `distance` prop. Accepts a number or `function(event)` returning a number.                                                                                                                                                                                                                                                |
